# TypeScript con la Options API {#typescript-with-options-api}
...
## Escritura de Propiedades Computadas {#typing-computed-properties}
...
## Aumento de las Opciones Personalizadas {#augmenting-custom-options}
